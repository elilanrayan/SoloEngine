...
dx3d::GraphicsDevice::GraphicsDevice(const GraphicsDeviceDesc& desc) : Base(desc.base)
{
	...
	DX3DGraphicsLogThrowOnFail(D3D11CreateDevice(NULL, D3D_DRIVER_TYPE_HARDWARE, NULL, createDeviceFlags, NULL,
...
void dx3d::GraphicsDevice::executeCommandLists(DeviceContext& context)
{
...
GraphicsResourceDesc dx3d::GraphicsDevice::getGraphicsResourceDesc()  noexcept
{
